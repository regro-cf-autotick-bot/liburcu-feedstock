...
Once the `conda-forge` channel has been enabled, `liburcu` can be installed with:

```
conda install liburcu
```

It is possible to list all of the versions of `liburcu` available on your platform with:
